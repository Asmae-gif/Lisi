...
/**
 * Composant de tableau de données optimisé et réutilisable
 * Utilise React.memo, useMemo et useCallback pour optimiser les performances
 */
interface Column<T> {
  key: keyof T;
  label: string;
...
const OptimizedDataTable = React.memo(<T extends Record<string, any>>({
  columns,
  data,
  title,
  onAdd,
